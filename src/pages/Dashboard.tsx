...
import { Building2, ClipboardList, CheckSquare, DollarSign, TrendingUp } from "lucide-react";
...
export default function Dashboard() {
  ...
  const [stats, setStats] = useState({ vendors: 0, activePOs: 0, pendingApprovals: 0, monthlySpend: 0 });
  ...
  useEffect(() => {
    (async () => {
      ...
      const [vendors, pos, prs, monthlyPays, recentOrders, allVendors] = await Promise.all([
      ...
      // 6-month spending trend from payments
